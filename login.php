					...
					<form class="form-horizontal" action="" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="username" id="username" type="text" placeholder="Correo electrónico..."/>
							</div>
							...
							<div class="button-login">	
                                                                <button type="button" class="btn btn-primary" id="enviar" onclick="presionSubmit()">Entrar</button>
							</div>
							<div class="clearfix"></div>
					</form>
					<hr>
